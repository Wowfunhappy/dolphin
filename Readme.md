...
3. cmake -DCMAKE_C_COMPILER=/opt/local/bin/clang-mp-14 -DCMAKE_CXX_COMPILER=/opt/local/bin/clang++-mp-14 -DCMAKE_CXX_FLAGS=-fno-aligned-allocation -DENABLE_VULKAN=OFF -DUSE_DISCORD_PRESENCE=OFF -DUSE_MGBA=OFF -DCMAKE_PREFIX_PATH=/usr/local/Qt-5.9.9/ ../dolphin/
